...
ExecuteAFile ( "/usr/local/lib/hyphy/TemplateBatchFiles/SelectionAnalyses/MEME.bf", inputRedirect );


##pay attention to change this file path to the location in your computer:
## /usr/local/lib/hyphy/TemplateBatchFiles/SelectionAnalyses/MEME.bf
