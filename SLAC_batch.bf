...
inputRedirect["05"]="100";
inputRedirect["06"]="0.1";
ExecuteAFile ( "/usr/local/lib/hyphy/TemplateBatchFiles/SelectionAnalyses/SLAC.bf", inputRedirect );


##pay attention to change this file path to the location in your computer:
## /usr/local/lib/hyphy/TemplateBatchFiles/SelectionAnalyses/SLAC.bf
